    ...
    return (
        <div className="containerArticle">
            <div className="textArticle">
                ...
                <p className="articleP">The black hole is locked in orbit with a young blue star dubbed LB-1, which sits about 13,800 light-years away in the constellation Gemini.</p>
